...
"}")
        ...
        self.page_widget_middle_1 = QtWidgets.QWidget()
        self.page_widget_middle_1.setObjectName("page_widget_middle_1")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.page_widget_middle_1)
        self.verticalLayout_3.setContentsMargins(0, 5, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.label_8 = QtWidgets.QLabel(self.page_widget_middle_1)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.verticalLayout_3.addWidget(self.label_8)
        self.progressBar_2 = QtWidgets.QProgressBar(self.page_widget_middle_1)
        ...
        self.stackedWidget.addWidget(self.page_widget_middle_1)
        self.page_widget_middle_2 = QtWidgets.QWidget()
        self.page_widget_middle_2.setObjectName("page_widget_middle_2")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.page_widget_middle_2)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.scrollArea = QtWidgets.QScrollArea(self.page_widget_middle_2)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 597, 142))
        ...
        self.progressBar_4.setMaximumSize(QtCore.QSize(16777215, 10))
        ...
        self.stackedWidget.addWidget(self.page_widget_middle_2)
        ...
        self.label_6 = QtWidgets.QLabel(self.widget_bottom)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_4.addWidget(self.label_6)
        self.label_7 = QtWidgets.QLabel(self.widget_bottom)
    ...
    def retranslateUi(self, Dialog_GameInstall):
        ...
        self.label_3.setText(_translate("Dialog_GameInstall", "原版Jar下载"))
        self.label_2.setText(_translate("Dialog_GameInstall", "游戏资源文件下载 (方式A)"))
        self.label_5.setText(_translate("Dialog_GameInstall", "游戏支持库文件下载+安装"))
        self.label_6.setText(_translate("Dialog_GameInstall", "1.1MB/s"))
        self.label_7.setText(_translate("Dialog_GameInstall", "5MB/231MB"))
