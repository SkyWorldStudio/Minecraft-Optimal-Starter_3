...
"}")
        ...
        self.progressBar_inatall_Jar.setMaximum(-1)
        self.progressBar_inatall_Jar.setProperty("value", -1)
        ...
        self.progressBar_inatall_assetsFile.setProperty("value", 24)
        ...
        self.progressBar_inatall_libraryFile.setProperty("value", 24)
