...
class Ui_Dialog_AddUserWindows(object):
    def setupUi(self, Dialog_AddUserWindows):
        ...
        Dialog_AddUserWindows.resize(585, 263)
...
"}")
        ...
        self.gridLayout_2.setContentsMargins(-1, -1, 12, 10)
    ...
    def retranslateUi(self, Dialog_AddUserWindows):
        ...
        self.label_8.setText(_translate("Dialog_AddUserWindows", "<html><head/><body><p>请点击&quot;登陆&quot;按钮开始进行微软登陆。在您点击登录按钮后，启动器会弹出一个窗口，并同时复制设备代码到您的剪贴板内(可以点击下方设备代码显示处重新复制), 您需要在窗口中完成登录(关闭登陆窗口意味着取消微软登陆)，并输入在此处显示的设备代码。若发现账号头像是默认头像、进入游戏后皮肤为默认皮肤或者无法进入开启正版认证的服务器，则可能需要重新添加微软账户。<br>- 如果网站提示&quot;出现错误&quot;，请关闭弹出窗口，重新开始进行微软登陆<br>如果您没有正版账户，请<a href=\"https://www.minecraft.net/store/minecraft-java-bedrock-edition-pc\"><span style=\" text-decoration: underline; color:#0068da;\">购买正版Minecraft</span></a></p></body></html>"))
