...
class Ui_Dialog_AddUserWindows(object):
    def setupUi(self, Dialog_AddUserWindows):
        ...
        Dialog_AddUserWindows.resize(585, 229)
        Dialog_AddUserWindows.setMinimumSize(QtCore.QSize(585, 229))
        Dialog_AddUserWindows.setMaximumSize(QtCore.QSize(585, 235))
...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/widget_Sidebar/images/TriangleUpsideDown .png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout_2.addWidget(self.pushButton_OffLine_Advanced, 2, 0, 1, 2)
        self.widget = QtWidgets.QWidget(self.page_OffLine)
        ...
        self.widget_2 = QtWidgets.QWidget(self.page_OffLine)
