...
"")
        ...
        self.widget_1 = QtWidgets.QWidget(self.page_OffLine)
        ...
        self.gridLayout_2.addWidget(self.widget_1, 1, 0, 1, 3)
        self.stackedWidget_widget_2 = QtWidgets.QStackedWidget(self.page_OffLine)
        self.stackedWidget_widget_2.setMaximumSize(QtCore.QSize(16777215, 0))
        self.stackedWidget_widget_2.setSizeIncrement(QtCore.QSize(0, 0))
        self.stackedWidget_widget_2.setObjectName("stackedWidget_widget_2")
        ...
        self.widget_2 = QtWidgets.QWidget(self.page_widget_2)
        ...
        self.stackedWidget_widget_2.addWidget(self.page_widget_2)
        self.page_2_widget_2 = QtWidgets.QWidget()
        self.page_2_widget_2.setObjectName("page_2_widget_2")
        self.stackedWidget_widget_2.addWidget(self.page_2_widget_2)
        self.gridLayout_2.addWidget(self.stackedWidget_widget_2, 5, 0, 1, 3)
